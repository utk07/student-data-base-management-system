...
student rec[100];  //This is basic array of defined structure to sore data.
int main()
{
  system("CLS");
  system("color B4");
  ...
  int searchkey;  //int variable to store student registration number by which user can search.
  ...
  switch(choice)
 {
   ...
   { 
     ...
     cout<<"--------------------------------------------------------------------------------"<<endl; 
     cout<<"ID   "<<"registration number"<<"Name  "<<"Father\tCell no.  "<<"DOB     "<<"Address\n\n";
     cout<<"--------------------------------------------------------------------------------"<<endl; 
  ...
  case 3:
    if(rec[0].regno==0)     //If no record exist then ask the user o enter records first.
   {   
     cout<<"Please Add sudents first."<<endl;
     system("pause");
   ...
   {
     cout<<"Enter registration number of student you want to search: ";
     cin>>searchkey;     //registration_number as the search key can be entered by user.
...
void search_student(int searchkey)
{
 ...
 { 
   if(rec[i].regno==searchkey)    //If registration number matches to search term.
  {   
    cout<<"ID   "<<"registration number"<<"Name   "<<"Father\tCell no.  "<<"DOB     "<<"Address\n\n";
